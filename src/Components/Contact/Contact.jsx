...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "0c889ca6-ec7f-405c-8ede-464b20773de1");
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                <li><img src={mail_icon} alt="" />Contact@edusity.web</li>
                <li><img src={phone_icon} alt="" />+105 440-593-7</li>
